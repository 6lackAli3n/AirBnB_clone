...
class TestBaseModel(unittest.TestCase):
    ...
    def test_to_dict_method(self):
        ...
        self.assertEqual
        (base_model_dict['created_at'], self.base_model.created_at.isoformat())
        self.assertEqual
    ...
    def test_init_method(self):
        ...
        self.assertEqual
        (base_model2.created_at, datetime.datetime(2023, 1, 1, 12, 0))
        self.assertEqual
        (base_model2.updated_at, datetime.datetime(2023, 1, 1, 12, 0))
